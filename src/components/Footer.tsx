    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center mb-4">
              ...
              <h1 className="ml-2 text-xl text-white font-heading font-semibold">Daily Digest</h1>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              Stay ahead with daily insights on artificial intelligence, delivered straight to your inbox. Curated by experts, designed for professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span>info@aidailydigest.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center md:flex md:justify-between md:text-left">
          <p>&copy; 2025 AI Daily Digest. All rights reserved.</p>
