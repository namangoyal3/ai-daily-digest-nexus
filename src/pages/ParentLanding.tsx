        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Developer, CodeX Solutions</p>
                  </div>
                </div>
                <p className="text-gray-700 italic">
                  "The AI courses offered here gave me practical skills I could apply immediately.
                  Within weeks of completion, I was leading AI initiatives at my company."
                </p>
                <div className="flex text-yellow-400 mt-4">
                  <Star className="w-5 h-5 fill-yellow-400" />
                  <Star className="w-5 h-5 fill-yellow-400" />
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              <h3 className="text-xl font-bold mb-6 text-center">Trusted by Companies Worldwide</h3>
              ...
              <div className="flex flex-wrap justify-center mt-8 gap-x-12 gap-y-4 text-center text-gray-600">
                <div>
                  <div className="text-2xl font-bold text-aiblue">100,000+</div>
                  <div className="text-sm">Active Users</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-aipurple">1,500+</div>
                  <div className="text-sm">AI Tools Listed</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-aiteal">20,000+</div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-8">
              ...
              <p className="text-xl opacity-90 max-w-3xl mx-auto">
                Join our community of AI enthusiasts, professionals, and learners.
                Stay informed, discover powerful tools, and develop in-demand skills.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-xl mx-auto">
              ...
              <Button asChild size="lg" className="flex-1 bg-white text-aiblue hover:bg-gray-100">
                <Link to="/ai-agents">
                  Explore AI Tools
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="flex-1 text-white border-white hover:bg-white/10">
                <Link to="/ai-courses">
                  Browse Courses
                </Link>
              </Button>
            ...
            <p className="text-center text-sm opacity-80 mt-6">
              Join 50,000+ professionals who are already ahead of the AI curve.
